...
contract SupplyChain {
  ...
  {
  owner = _originFarmerID;
    // Add the new item as part of Harvest
  items[_upc] = Item(sku, _upc, owner, _originFarmerID, _originFarmName,
                     _originFarmInformation, _originFarmLatitude, _originFarmLongitude, 
                      _upc+sku, _productNotes, 0, State.Harvested, address(0), address(0), address(0));
    // Increment sku
    sku = sku + 1;
